    ...
    "1": function(require, module, exports, global) {
        ...
        PNG.prototype.getPixel = function(x, y) {
            ...
            switch (this.colorType) {
              case 0:
                return [ colors[0], colors[0], colors[0], 255 ];
              case 2:
                return [ colors[0], colors[1], colors[2], 255 ];
              case 3:
                return [ this.palette[colors[0] * 3 + 0], this.palette[colors[0] * 3 + 1], this.palette[colors[0] * 3 + 2], 255 ];
              case 4:
                return [ colors[0], colors[0], colors[0], colors[1] ];
              case 6:
